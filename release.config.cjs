const rules = [
  ...
  { type: 'remove', release: 'patch', title: '🗑️ Removals' },
  { type: 'cleanup', release: 'patch', title: '🧹 Cleanup' },
  { type: 'build', release: 'patch', title: '📦 Build' },
  { type: 'raw', release: 'patch', title: '🗃️ Raw Data' },
  { type: 'docs', release: 'patch', title: '📚 Documentation' },
  { type: 'chore', release: 'patch', title: '🛠️ Other changes' },
  { type: 'test', release: false, title: '🧪 Tests' },
  { type: 'ci', release: false, title: '⚙️ Continuous Integration' },
  { type: 'style', release: false, title: '💅 Style' },
];
